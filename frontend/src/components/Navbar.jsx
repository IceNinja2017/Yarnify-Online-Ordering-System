...
const Navbar = () => {
    ...
    return (
        <nav className="bg-[#ebd8d0] shadow-md">
                        ...
                        {!isLoggedIn ? (
                            <>
                                ...
                                <div className="flex w-max overflow-hidden border border-[#d3ab9e]">
                                    <a href="/login" className="bg-[#d3ab9e] text-white px-6 py-2 rounded-l-full hover:bg-[#BD8F80] transition">
                                        Login
                                    </a>
                                    <a href="/register" className="bg-[#d3ab9e] text-white px-6 py-2 rounded-r-full hover:bg-[#BD8F80] transition">
                                        Register
                                    </a>
                                </div>
                ...
                <div className="md:hidden bg-[#ebd8d0] px-4 pb-4 space-y-2">
                    {!isLoggedIn ? (
                        <>
                            ...
                            <a href="/login" className="block bg-[#d3ab9e] text-white text-center py-2 rounded-xl hover:bg-[#BD8F80] transition">
                                Login
                            </a>
                            <a href="/register" className="block bg-[#d3ab9e] text-white text-center py-2 rounded-xl hover:bg-[#BD8F80] transition">
                                Register
                            </a>
                        </>
                    ) : (
